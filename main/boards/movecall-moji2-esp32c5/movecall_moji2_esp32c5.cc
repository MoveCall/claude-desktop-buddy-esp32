...
class MovecallMoji2ESP32C5 : public Board {
private:
    Button boot_button_;
    Display* display_;

    void InitializeSpi() {
        const spi_bus_config_t bus_config = MOJI2_ST77916_PANEL_BUS_QSPI_CONFIG(
            DISPLAY_QSPI_SCLK_PIN,
            DISPLAY_QSPI_D0_PIN, DISPLAY_QSPI_D1_PIN,
    ...
    void InitializeSt77916Display() {
        ...
        esp_lcd_panel_io_spi_config_t io_config = ST77916_PANEL_IO_QSPI_CONFIG(
            DISPLAY_QSPI_CS_PIN, NULL, NULL);
        ESP_ERROR_CHECK(esp_lcd_new_panel_io_spi(
            (esp_lcd_spi_bus_handle_t)DISPLAY_QSPI_HOST, &io_config, &panel_io));
...
public:
    ...
    virtual std::string GetBoardType() override { return "movecall-moji2-esp32c5"; }
